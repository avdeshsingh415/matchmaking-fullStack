...
- Clone the Repository
    - git clone [https://github.com/avdeshsingh415/matchmaking-fullStack]

    - Navigate to the project directory:
        - cd matchmaking-fullStack
